        ...
        <section class="flat-spacing-2 black-overlay pb-0">
            <div class="container">
                <div class="page-title">
                    ...
                    <div class="box-text">
                        <p class="text-main-4">
                            At Vemus, we believe jewelry is more than an accessory—it’s a reflection of your story. With a
                            <br class="d-none d-xxl-block">
                            passion for craftsmanship and a commitment to quality, we create timeless pieces that celebrate
                            <br class="d-none d-xxl-block">
                            life’s moments, big and small. From delicate everyday essentials to statement designs, each
                            <br class="d-none d-xxl-block">
            ...
            <div class="container">
                <div class="main-legal">
                    <div class="legal-wrap">
                        <h3 class="legal-title">1. Information We Collect</h3>
                        <p class="legal-sub">
                            When you visit the Site, we automatically collect certain information about your device, including information about your
                            web browser, IP address, time zone, and some of the cookies that are installed on your device. Additionally, as you browse
                            the Site, we collect information about the individual web pages or products that you view, what websites or search terms
                            referred you to the Site, and information about how you interact with the Site. We refer to this automatically collected
                            ...
                            <br>
                            <br>
                            "Cookies" are data files that are placed on your device or computer and often include an anonymous unique identifier. For
                            more information about cookies, and how to disable cookies, visit this link:
                            <br>
                            <br>
                            (.....) 
                            <br>
                            ...
                            <br>
                            <br>
                            Additionally, when you make a purchase or attempt to purchase through the Site, we collect certain information from you,
                            including your name, billing address, shipping address, and payment information (including credit card number, email
                            address, and phone number. We refer to this information as "Order Information".)
                        </p>
                    </div>
                    <div class="legal-wrap">
                        <h3 class="legal-title">2. How We Use Your Information</h3>
                        <p class="legal-sub">
                            We use the Order Information that we collect generally to fulfill any orders placed through the Site (including processing
                            your payment information, arranging for shipping, and providing you with invoices and/or order confirmations).
                    ...
                    <div class="legal-wrap">
                        <h3 class="legal-title">3. Sharing Your Personal Information</h3>
                        <p class="legal-sub">
                            We share your Personal Information with third parties to help us use your Personal Information, as described above. For
                            example, we use Shopify to power our online store--you can read more about how Shopify uses your Personal Information
                    ...
                    <div class="legal-wrap">
                        <h3 class="legal-title">4. Data Retention</h3>
                        <p class="legal-sub">
                    ...
                    <div class="legal-wrap">
                        <h3 class="legal-title">5. Your Rights</h3>
                        <p class="legal-sub">
                            You are responsible for maintaining the confidentiality of your account and password information, and you agree to accept
                            responsibility for all activities that occur under your account and password. This website and The Company Pte Ltd
                            reserves the right to refuse service, terminate accounts remove or edit content or cancel orders.By placing an order, you
                            warrant that you are over 18 years of age, and that you are providing shop.company.com or shop.beetle.com.sg with
                            accurate, truthful information and that you have the authority to place the order.
                        </p>
                    </div>
                    <div class="legal-wrap">
                        <h3 class="legal-title">6. Changes</h3>
                        <p class="legal-sub">
                            We may update this privacy policy from time to time to reflect, for example, changes to our practices or for other
                            operational, legal, or regulatory reasons.
                        </p>
                    </div>
                    <div class="legal-wrap">
                        <h3 class="legal-title">7. Contact Us</h3>
                        <p class="legal-sub">
                            For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please
                            contact us by e-mail at [Email Address] or by mail using the details provided below:
                            <br><br>
                            <a href="mailto:contact@vemus.com" class="text-main-6 link">contact@vemus.com</a>
                        </p>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from themesflat.co/html/vemus/privacy.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 May 2025 06:19:17 GMT -->
</html>