...
Discover jewellery designed for every occasion. From everyday elegance to timeless bridal treasures,                         <br class="d-none d-xl-block">
        ...
        <!-- /Category -->
         ...
         <!-- Best Seller -->
        <section class="flat-spacing-3 flat-animate-tab product-tablist cat">
            <div class="container">
                <div class="sect-top align-items-end wow fadeInUp">
                    <h2 class="s-title text-capitalize">Best Sellers</h2>
        ...
        <!-- <section class="flat-spacing-3">
            <div class="container">
                <div class="sect-top center text-center wow fadeInUp">
                    <h2 class="s-title font-2 text-capitalize"><span class="fst-italic">Our</span> Categories</h2>
                    <p class="s-sub-title">
                ...
                <div class="tf-grid-layout  sm-col-2 xl-col-3 category-grid wow fadeInUp">
                    <div class="item_1">
                        <a href="shop-left-sidebar.html" class="wg-category hover-img4">
                            <div class="image img-style4">
                                <img src="images/jewellery/c1.png" data-src="images/jewellery/c1.png" alt="" class="lazyload">
                            </div>
                        ...
                        <a href="shop-left-sidebar.html" class="wg-category hover-img4">
                            <div class="image img-style4">
                                <img src="images/jewellery/c2.png" data-src="images/jewellery/c2.png" alt="" class="lazyload">
                            </div>
                            <h3 class="btn-view link">
                                UNDER $92
                                <i class="icon icon-arrow-top-right"></i>
                    ...
                    <div class="item_2">
                        <a href="shop-left-sidebar.html" class="wg-category hover-img4">
                            <div class="image img-style4">
                                <img src="images/jewellery/c5.webp" data-src="images/jewellery/c5.webp" alt="" class="lazyload">
                            </div>
                            <h3 class="btn-view link">
                                UNDER $63
                                <i class="icon icon-arrow-top-right"></i>
                    ...
                    <div class="item_3">
                        <a href="shop-left-sidebar.html" class="wg-category hover-img4">
                            <div class="image img-style4">
                                <img src="images/jewellery/c3.png" data-src="images/jewellery/c3.png" alt="" class="lazyload">
                            </div>
                            <h3 class="btn-view link">
                                UNDER $88
                                <i class="icon icon-arrow-top-right"></i>
                        ...
                        <a href="shop-left-sidebar.html" class="wg-category hover-img4">
                            <div class="image img-style4">
                                <img src="images/jewellery/c4.png" data-src="images/jewellery/c4.png" alt="" class="lazyload">
                            </div>
                            <h3 class="btn-view link">
                                UNDER $79
                                <i class="icon icon-arrow-top-right"></i>
